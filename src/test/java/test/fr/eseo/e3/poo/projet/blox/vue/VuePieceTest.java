...
public class VuePieceTest {
    ...
    void setUp() {
        ...
        // Création d'une liste d'éléments pour la pièce
        ...
        // Création de l'objet VuePiece
        vuePiece = new VuePiece(pieceMock, 30); // Taille des cases : 30 pixels
    }
    ...
    void testAfficherPiece() {
        ...
        assertDoesNotThrow(() -> vuePiece.afficherPiece(graphicsMock,10,10), "La méthode afficherPiece ne devrait pas lever d'exception");
